...
def generate_pipes(args)
  args.outputs.solids << [2,2,100,100]
  args.outputs.solids << [1000, 720, 100, -args.state.upper_height - (720 - args.state.lower_height)]
  args.outputs.solids << [1000, 720 - args.state.lower_height, 100, -args.state.lower_height]
end
